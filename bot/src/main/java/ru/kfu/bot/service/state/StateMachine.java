...
public class StateMachine {
    ...
    private void handleAffineCount(Long chatId, String message) {
        ...
        try {
            ...
            telegramMessenger.sendMessage(chatId, "Введите количетво симметрии для фрактала (пример: 4):");
    ...
    private void handSymmetryCount(Long chatId, String message) {
        ...
        try {
            ...
            telegramMessenger.sendMessage(chatId, "Введите количество начальных точек (пример: 10):");
    ...
    private void handleSamples(Long chatId, String message) {
        ...
        try {
            ...
            telegramMessenger.sendMessage(chatId, "Введите количество итерации на одну начальную точку (пример: 1000000):");
    ...
    private void handleIterations(Long chatId, String message) {
        ...
        try {
            ...
            telegramMessenger.sendMessage(chatId, "Введите ширину (количество пикселей) разрешения изображения (пример: 1000):");
    ...
    private void handleImageWidth(Long chatId, String message) {
        ...
        try {
            ...
            telegramMessenger.sendMessage(chatId, "Введите выосоту (количество пикселей) разрешения изображения (пример: 1000):");
    ...
    private void handleImageHeight(Long chatId, String message) {
        ...
        try {
            ...
            telegramMessenger.sendMessage(chatId, "Введите координату X нижнего левого угла видимой области (пример: -1.5):");
    ...
    private void handleRectX(Long chatId, String message) {
        ...
        try {
            ...
            telegramMessenger.sendMessage(chatId, "Введите координату Y нижнего левого угла видимой области (пример: -1.5):");
    ...
    private void handleRectY(Long chatId, String message) {
        ...
        try {
            ...
            telegramMessenger.sendMessage(chatId, "Введите ширину видимой области (пример: 3):");
    ...
    private void handleRectWidth(Long chatId, String message) {
        ...
        try {
            ...
            telegramMessenger.sendMessage(chatId, "Введите высоту видимой области (пример: 3):");
    ...
    private void handleRectHeight(Long chatId, String message) {
        ...
        try {
            ...
            telegramMessenger.sendMessage(chatId, "Доступные трансформации:");
    ...
    private void handleHistoryConfig(Long chatId, String message) {
        ...
        try {
            ...
            log.error("Error getting transformation types {}", chatId, e);
            telegramMessenger.sendMessage(chatId, "Произошла ошибка при генерации фрактала. Попробуйте еще раз!");
            inMemoryUserStateRepository.setState(chatId, BotState.DEFAULT);
        }
    }
